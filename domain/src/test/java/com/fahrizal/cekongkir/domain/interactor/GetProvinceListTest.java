...
public class GetProvinceListTest {
  ...
  @Before
  public void setUp() {
    getProvinceList = new GetProvinceList(mockProvinceRepository, mockThreadExecutor,
        mockPostExecutionThread);
  }

  @Test
  public void testGetUserListUseCaseObservableHappyCase() {
    getProvinceList.buildUseCaseObservable(null);

    verify(mockProvinceRepository).provinces();
