...
public class DiskProvinceDataStoreTest {

  private static final int FAKE_USER_ID = 11;

  private DiskProvinceDataStore diskUserDataStore;
  ...
  @Before
  public void setUp() {
    diskUserDataStore = new DiskProvinceDataStore(mockProvinceCache);
  }
  ...
  public void testGetUserEntityDetailesFromCache() {
    ...
    verify(mockProvinceCache).get(FAKE_USER_ID);
  }
}
