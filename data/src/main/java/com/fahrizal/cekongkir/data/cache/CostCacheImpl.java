 ...
 */
@Singleton
public class CostCacheImpl implements CostCache {
  ...
  /**
   * Constructor of the class {@link CostCacheImpl}.
   *
   * @param context A
   ...
   */
  @Inject
  CostCacheImpl(Context context, Serializer serializer,
  ...
  @Override public Observable<ProvinceEntity> get(final int userId) {
    return Observable.create(emitter -> {
      final File userEntityFile = CostCacheImpl.this.buildFile(userId);
      final String fileContent = CostCacheImpl.this.fileManager.readFileContent(userEntityFile);
      final ProvinceEntity provinceEntity =
          CostCacheImpl.this.serializer.deserialize(fileContent, ProvinceEntity.class);
