...
public class CityCacheImpl implements CityCache {
    ...
    public Observable<CityEntity> get(final int cityId) {
        return Observable.create(emitter -> {
            ...
            final String fileContent = CityCacheImpl.this.fileManager
                .readFileContent(userEntityFile);
    ...
    public void put(CityEntity cityEntity) {
        if (cityEntity != null) {
            ...
            if (!isCached(cityEntity.getId())) {
                final String jsonString = this.serializer
                    .serialize(cityEntity, ProvinceEntity.class);
    ...
    @Override
    public boolean isCached(int provinceId) {
