...
public class CoveredAreaListFragment extends BaseFragment implements ProvinceListView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View fragmentView = inflater
            .inflate(R.layout.fragment_covered_area_list, container, false);
...
//    ButterKnife.unbind(this);
    ...
    @Override
    public void renderUserList(Collection<ProvinceModel> provinceModelCollection) {
    ...
    @Override
    public void viewUser(ProvinceModel userModel) {
