...
public class UserListActivityTest extends ActivityInstrumentationTestCase2<ProvinceListActivity> {

  private ProvinceListActivity userListActivity;

  public UserListActivityTest() {
    super(ProvinceListActivity.class);
  }
  ...
  private Intent createTargetIntent() {
    Intent intentLaunchActivity =
        ProvinceListActivity.getCallingIntent(getInstrumentation().getTargetContext());
