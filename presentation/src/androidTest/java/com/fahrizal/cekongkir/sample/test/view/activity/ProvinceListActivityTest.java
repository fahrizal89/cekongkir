 ...
 */
package com.fahrizal.cekongkir.sample.test.view.activity;
...
public class ProvinceListActivityTest extends ActivityInstrumentationTestCase2<CoveredAreaListActivity> {

  private CoveredAreaListActivity userListActivity;

  public ProvinceListActivityTest() {
    super(CoveredAreaListActivity.class);
  }
  ...
  private Intent createTargetIntent() {
    Intent intentLaunchActivity =
        CoveredAreaListActivity.getCallingIntent(getInstrumentation().getTargetContext());
